...
export function EmailSection({
  ...
  const handleAddEmail = async (e: React.FormEvent) => {
    ...
    try {
      // 1. Create the alternate email first
      ...
      onNeedsReverification(
        ...
        "Alternate email address added and verified successfully.",
        {
          type: "email",
          prepareVerification: () => res.prepareVerification({ strategy: "email_code" }),
