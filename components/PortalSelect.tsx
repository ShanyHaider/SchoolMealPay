...
export function PortalSelect({
    ...
    const allOptions: SelectOption[] = noneLabel
        ? [{ value: "__none__", label: noneLabel }, ...options]
        : options;
    ...
    const handleOpen = () => {
        ...
        if (btnRef.current) {
            ...
            if (spaceBelow >= dropdownH + 8) {
                setCoords({ top: rect.bottom + 6, bottom: undefined, left: rect.left, width: rect.width });
            } else {
                setCoords({ top: undefined, bottom: window.innerHeight - rect.top + 6, left: rect.left, width: rect.width });
            }
        }
        setOpen(true);
    };
                                ...
                                return (
                                    <button
                                        ...
                                        style={{
                                            ...
                                            borderTop: i > 0 && isNone === false && allOptions[i - 1]?.value === "__none__"
                                        ...
                                        <div className="flex items-center gap-2.5 min-w-0">
                                            ...
                                            <div className="min-w-0">
                                                <p
                                                    ...
                                                    style={{
                                                        color: isSelected ? "var(--text-primary)" : isNone ? "var(--text-muted)" : "var(--text-secondary)",
