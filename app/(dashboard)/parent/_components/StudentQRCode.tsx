    ...
    return (
        <>
            ...
            <button
                ...
                className="flex items-center gap-2 rounded-xl border border-[var(--border-card)] bg-[var(--bg-secondary)] px-3 py-2 text-xs font-bold text-[var(--text-secondary)] hover:bg-[var(--bg-tertiary)] hover:text-[var(--text-primary)] transition-colors cursor-pointer"
            >
                <QrCode size={13} />
                Canteen QR
            </button>
                                ...
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <div className="relative p-4 rounded-2xl bg-white border border-zinc-100 dark:border-zinc-800 shadow-inner">
                                        ...
                                        {["top-0 left-0", "top-0 right-0", "bottom-0 left-0", "bottom-0 right-0"].map((pos) => (
                                            <div
                                                key={pos}
                                                className={`absolute ${pos} w-4 h-4 border-zinc-950 dark:border-white ${pos.includes("top") && pos.includes("left")
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-[11px] text-zinc-400 mt-0.5">{className}</p>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-1.5 rounded-xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 px-3 py-2 w-full">
                                        ...
                                        <p className="text-[10px] text-zinc-400 leading-relaxed">
                                            This QR is unique to {studentName.split(" ")[0]}. Do not share it publicly.
                                        </p>
                                    </div>
                                </div>
