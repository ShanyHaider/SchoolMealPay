...
import { AUDIT_ACTIONS, AUDIT_ENTITY_TYPES } from "@/types/auditConstants";
import { PortalSelect } from "@/components/PortalSelect";
import type { SelectOption } from "@/components/PortalSelect";

// ─── Action badge colour map ──────────────────────────────────────────────────

const ACTION_COLOURS: Record<string, { bg: string; color: string; border: string; dot: string }> = {
    user_blocked: {
