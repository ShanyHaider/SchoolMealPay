...
import type { SystemHealthData } from "@/db/queries/SystemAdminSystemHealth";
    ...
    >
      ...
      : <div className="space-y-2.5">
          {breakdown.map((row) => {
            ...
            const c = STATUS_COLOUR[row.status] ?? {
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            ...
            <p
              ...
              style={{
                color:
                  db.latencyMs < 200 ? "#22c55e"
                  : db.latencyMs < 600 ? "#f59e0b"
                  : "#ef4444",
              }}
            >
              {db.latencyMs}ms
