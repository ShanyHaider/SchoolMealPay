        ...
        return (
            ...
            >
                <div className="py-16 text-center">
                    <UserCog size={32} className="mx-auto mb-3" style={{ color: "var(--text-muted)" }} />
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr style={{ borderBottom: "1px solid var(--border-primary)" }}>
                            {["Staff Member", "Email", "Status", "Canteen", "Actions"].map((h) => (
                                <th
                                    key={h}
                    ...
                    {assignment ? (
                        ...
                        >
                            ...
                            <button
                                ...
                                disabled={actionsPending}
                                className="ml-0.5 flex items-center justify-center w-4 h-4 rounded hover:bg-[var(--bg-secondary)] transition-colors disabled:opacity-40"
                                style={{ color: "var(--text-muted)" }}
                            >
                                <X size={10} />
                            </button>
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            ...
                            >
                                {isAssignPending ? <Loader2 size={11} className="animate-spin" /> : "Save"}
                            </button>
                            <button
                                onClick={() => { setShowAssignUI(false); setSelectedCanteenId(""); }}
                                className="flex items-center justify-center w-6 h-6 rounded-lg transition-colors hover:bg-[var(--bg-tertiary)]"
                        ...
                        <button
                            ...
                            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium disabled:opacity-50 transition-colors hover:bg-[var(--bg-tertiary)]"
                            style={{
