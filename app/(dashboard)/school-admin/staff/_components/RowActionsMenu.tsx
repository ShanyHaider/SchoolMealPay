                    ...
                    <>
                        ...
                        >
                            ...
                            <button
                                ...
                                className="flex items-center gap-2.5 w-full px-3 py-2.5 text-xs transition-colors hover:bg-[var(--bg-secondary)]"
                                style={{ color: isDisabled ? "#34d399" : "#f59e0b" }}
                            >
                                <span
                                    className="flex items-center justify-center w-6 h-6 rounded-md flex-shrink-0"
                                    style={{
                                        background: isDisabled ? "rgba(52,211,153,0.12)" : "rgba(245,158,11,0.12)",
                                    }}
                                >
                                    {isDisabled ? <UserCheck size={12} /> : <UserX size={12} />}
                                </span>
                                {isDisabled ? "Enable access" : "Disable staff"}
                            </button>

                            <div className="mx-3 my-1 border-t" style={{ borderColor: "var(--border-primary)" }} />
