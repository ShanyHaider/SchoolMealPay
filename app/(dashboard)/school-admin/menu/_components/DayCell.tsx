...
export function DesktopDayCell({
  ...
  return (
    <div
      className="p-2 min-h-50 flex flex-col"
      style={{
    ...
    >
      ...
      <div className="mt-1.5">
        ...
        : <button
            ...
            className="w-full py-1 rounded text-xs transition-all hover:bg-(--bg-tertiary) flex items-center justify-center gap-1 disabled:opacity-40"
            style={{
