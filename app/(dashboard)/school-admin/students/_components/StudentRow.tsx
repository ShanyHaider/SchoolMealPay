...
export function StudentRow({
  ...
  const approvedParents =
    student.parentLinks?.filter((l) => l.status === "approved") ?? [];
  ...
  if (viewMode === "card") {
    return (
      <>
        <div className="flex flex-col px-5 py-6 space-y-5 bg-transparent transition-colors hover:bg-(--bg-secondary) w-full">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <button
                ...
                className="rounded-xl p-2.5 transition-colors hover:bg-(--bg-tertiary) border"
                style={{
          ...
          {student.allergens && student.allergens.length > 0 && (
            <div
              className="pt-3.5 border-t flex flex-wrap items-center gap-2"
              style={{ borderColor: "var(--border-primary)" }}
            >
              <span
      ...
      >
        ...
        <td className="px-4 py-3">
          <div className="flex items-center gap-1">
            <button
              onClick={() => onEdit(student)}
              className="rounded-lg p-1.5 transition-colors hover:bg-(--bg-tertiary)"
              title="Edit student"
              style={{ color: "var(--text-muted)" }}
            >
              <Pencil size={13} />
