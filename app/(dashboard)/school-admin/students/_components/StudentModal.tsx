            ...
            >
                ...
                <div className="space-y-4">
                    ...
                    <ClassSelector
                        ...
                        onChange={(value) => setForm({ ...form, classId: value ?? undefined })}
                    ...
                    {isEditing && (
                        <label
                            className="flex cursor-pointer items-center gap-3 rounded-lg border p-3 transition-colors hover:bg-[var(--bg-tertiary)]"
                            style={{
                        ...
                        >
                            <input
                                ...
                                onChange={(e) => setForm({ ...form, orderingEnabled: e.target.checked })}
