      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-10 items-end">
          <div>
            ...
            <h2
              className="text-4xl lg:text-5xl font-normal leading-[1.1] tracking-[-0.03em] mb-0"
              style={{
      ...
      <div className="max-w-6xl mx-auto px-6 py-14">
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-10">
          ...
          <div className="col-span-2 sm:col-span-4 lg:col-span-1">
            <Link
              href="/"
              className="inline-block text-xl font-normal mb-4"
              style={{
                fontFamily: "'Instrument Serif', serif",
                color: "var(--text-primary)",
              }}
            ...
            <p
              ...
              style={{ color: "var(--text-muted)" }}
            >
              Connecting parents, canteen staff, and school admins around every
              meal.
            </p>
            ...
            : <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 rounded-lg text-sm font-medium shrink-0 transition-all hover:scale-105"
                  style={{
                    background: "var(--accent)",
                    color: "var(--accent-text)",
                  }}
