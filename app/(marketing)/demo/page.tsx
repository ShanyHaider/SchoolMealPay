...
const WHAT_YOULL_SEE = [
  {
    ...
    desc: "Ordering, spending limits, nutrition trends",
  },
  {
    icon: Monitor,
    label: "Admin panel",
    desc: "Menu scheduling, student management, reports",
  },
  {
    icon: Video,
    label: "Live orders board",
    desc: "Kanban view, status transitions, allergen cards",
  },
  {
    icon: Clock,
    label: "QR pickup flow",
    desc: "Scan, verify, collect — end to end in 2 seconds",
  },
];
...
export default function DemoPage() {
  ...
  if (submitted) {
    return (
      <div
        className="min-h-screen flex items-center justify-center px-6 py-6 pt-30 lg:pt-40 lg:py-8"
      ...
      >
        <Reveal>
          <div className="max-w-lg w-full text-center">
            ...
            <DisplayHeading className="text-5xl mb-4">
              You&apos;re booked.
            </DisplayHeading>
            <p
            ...
            >
              Confirmation coming to{" "}
              <strong style={{ color: "var(--text-primary)" }}>
                {form.email}
              </strong>{" "}
              within the hour, with a Zoom link for{" "}
              <strong style={{ color: "var(--text-primary)" }}>
                {selectedSlot}
    ...
    >
      <div className="max-w-6xl mx-auto px-6 pt-30 lg:pt-40 pb-28">
        ...
        <div className="text-center mb-16">
          <Reveal>
            <EyebrowLabel>Free 20-minute demo</EyebrowLabel>
          </Reveal>
          <Reveal delay={0.06}>
          ...
          <Reveal delay={0.12}>
            <p className="text-lg" style={{ color: "var(--text-secondary)" }}>
              We&apos;ll walk through the full flow — parent ordering, QR
              pickup, admin analytics — live.
            </p>
          </Reveal>
        </div>
            ...
            <Reveal>
              ...
              >
                <div className="px-8 pt-8 pb-4">
                  ...
                  <div className="space-y-5">
                    {WHAT_YOULL_SEE.map(({ icon: Icon, label, desc }, i) => (
            ...
            <Reveal delay={0.1}>
              ...
              >
                <p
                  ...
                  style={{ color: "var(--text-secondary)" }}
                >
                  "The QR pickup feature alone is worth switching for. Our
                  canteen queue dropped from 20 minutes to under 4."
                </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.school}
                    onChange={f("school")}
                    placeholder="e.g. Beacon House School System"
                    style={inputStyle}
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={
                    !form.name || !form.email || !form.school || !selectedSlot
                  }
